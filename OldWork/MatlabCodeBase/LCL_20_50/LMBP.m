   ...
   % save(strcat(num2str(jjj),'w_Lm_ini.mat'), 'W1', 'W2', 'W3');
    ...
    for iteration=1:numIterations
        while (mu < mu_max)
            ...
            for i=1:numSamples
                [J_total,e_hist_err,J_matix]=unrollTrajectoryFull(idq_startPositions(:,i),i,trajectoryLength,W3,W2,W1);
...
%                 fprintf('reach mu_max1 \n');
            ...
            J_total_sum2=0;
            for i=1:numSamples
                J_total2= unrollTrajectoryFull(idq_startPositions(:,i),i,trajectoryLength,W3_temp,W2_temp,W1_temp);
