function [o3,Dnet_Dw,Dnet_Didq,Dnet_Dhist_err]= net_action(idq, idq_ref, hist_err,W3,W2,W1,flag,useShortcuts, use_idq)

%  useShortcuts use_idq;
global Gain Gain2 Gain3 
% Gain=1000;
% Gain2=100*2;
% Gain3=100*2;
%%
...
if flag ==1
    ...
    %% compute Dnet_Didq
    if use_idq==1;
        Dinput1_OA_OB_Didq=[diag((1-output0A.^2)/Gain);diag((1-output0B.^2)/Gain2)];
    else
